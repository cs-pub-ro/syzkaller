...
#if (SYZ_EXECUTOR || __NR_syz_emit_ethernet && SYZ_NET_INJECTION) && !GOOS_unikraft
#include <stdbool.h>
#include <sys/uio.h>
...
#if (SYZ_EXECUTOR || __NR_syz_extract_tcp_res && SYZ_NET_INJECTION) && !GOOS_unikraft
#ifndef __ANDROID__
...
#if (SYZ_EXECUTOR || __NR_syz_open_dev) && !GOOS_unikraft
#include <fcntl.h>
#include <string.h>
#include <sys/stat.h>
#include <sys/types.h>
...
#if (SYZ_EXECUTOR || __NR_syz_open_procfs) && !GOOS_unikraft
#include <fcntl.h>
#include <string.h>
#include <sys/stat.h>
#include <sys/types.h>
...
#if (SYZ_EXECUTOR || __NR_syz_open_pts) && !GOOS_unikraft
#include <fcntl.h>
#include <sys/ioctl.h>
#include <sys/stat.h>
#include <sys/types.h>
...
#if (SYZ_EXECUTOR || __NR_syz_init_net_socket) && !GOOS_unikraft
...
#if (SYZ_EXECUTOR || __NR_syz_genetlink_get_family_id) && !GOOS_unikraft
#include <errno.h>
#include <linux/genetlink.h>
#include <linux/netlink.h>
#include <sys/socket.h>
...
#if (SYZ_EXECUTOR || __NR_syz_read_part_table) && !GOOS_unikraft
...
#if (SYZ_EXECUTOR || __NR_syz_mount_image) && !GOOS_unikraft
#include <string.h>
#include <sys/mount.h>
